            ...
            <div class="col-sm-12">
                ...
                -->
                    ...
                    if (!empty($allCulatorsDaat)) {
                        $i = 1;
                        foreach ($allCulatorsDaat as $allCulators):
                            if ($allCulators['calculators_name'] == 2 && $allCulators['gcategory'] == 1) {
                                ?>
                                <li>
                                    <a href="#!" class="calculatorHendler" data-urlname="<?= $allCulators['urlName']; ?>"
                                        aria-label="<?= $allCulators['titleName']; ?>">
                        ...
                        echo "<p>Currently calculators data not available. Please try again later.</p>";
                    } ?>
                </ul>
